...
import {
	...
	SidebarSpacer,
	SidebarTitle,
} from "@/components/app/sidebar/components";
import { SidebarItem } from "@/components/app/sidebar/item";
import Link from "next/link";
import TeamSwitcher from "@/components/app/team-switcher";

export default function AesteriskSidebar({ teamID }: { teamID: Promise<string>; }) {
	return (
		<>
			<SidebarTitle>
				<Link href="/">
					<Button variant="link" className="flex items-center gap-2 font-semibold text-lg p-1" svg="keep-size">
